...
public static class AppInfo
{
    ...
    public static string PostgreSQLConnectionString { get; } = "Host=localhost;Port=5436;Database=diffusion_images;Username=diffusion;Password=diffusion_toolkit_secure_2025";
