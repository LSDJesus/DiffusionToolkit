...
public class JoyTagService : IDisposable
{
    ...
    public JoyTagService(string modelPath, string tagsPath)
    {
    ...
    private async Task LoadTagsAsync()
    {
        ...
        _tags = lines
            .Skip(1) // Skip header
            .Select(line => line.Split(',')[1].Trim('"')) // Get tag name from CSV
            .Select(tag => tag.Replace("_", " ")) // Replace underscores with spaces
            .ToArray();
    }
